...
import com.majie.stugrade.ui.weather.adapter.LifeIndexAdapter;
import com.majie.stugrade.ui.weather.adapter.WeatherForecastAdapter;
import com.majie.stugrade.ui.weather.model.Weather;
import com.majie.stugrade.ui.weather.model.WeatherResult;
import com.majie.stugrade.ui.weather.request.JSONRequest;
import com.majie.stugrade.ui.weather.utils.DataManager;
import com.majie.stugrade.ui.weather.utils.Utils;
import com.majie.stugrade.ui.weather.utils.WeatherImage;
import com.majie.stugrade.ui.weather.widget.MyListView;
...
public class WeatherActivity extends BaseActivity implements OnClickListener, OnItemClickListener, OnRefreshListener<ScrollView> {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (mWeather == null || !data.getStringExtra(CITY).equals(mWeather.getCurrentCity())) {
            ...
            tvCity.setText(mCity);
            llWeatherBg.setBackgroundResource(R.mipmap.ic_weather_bg_na);
