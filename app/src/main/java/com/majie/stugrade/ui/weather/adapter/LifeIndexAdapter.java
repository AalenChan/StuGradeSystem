 ...
 * 2015-3-28
 */
package com.majie.stugrade.ui.weather.adapter;
...
public class LifeIndexAdapter extends BaseAdapter {
    ...
    public LifeIndexAdapter(Context context, LifeIndex lifeIndexes[]) {
        ...
        this.mSelection = -1;
        mIcons = new int[]{R.mipmap.ic_life_index_icon_chuanyi,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position == mSelection) {
            ...
            holder.ivArrow.setImageResource(R.mipmap.ic_arrow_open);
        } else {
            holder.tvDes.setVisibility(View.GONE);
            holder.ivArrow.setImageResource(R.mipmap.ic_arrow_close);
        }
        return convertView;
    }
