...
public class CalendarUtils {
    ...
    public String toString() {
        ...
        sb.append("Gregorian Year: ").append(gregorianYear).append("\n");
        sb.append("Gregorian Month: ").append(gregorianMonth).append("\n");
        sb.append("Gregorian Date: ").append(gregorianDate).append("\n");
        sb.append("Is Leap Year: ").append(isGregorianLeap).append("\n");
        sb.append("Day of Year: ").append(dayOfYear).append("\n");
        sb.append("Day of Week: ").append(dayOfWeek).append("\n");
        sb.append("Chinese Year: ").append(chineseYear).append("\n");
        sb.append("Heavenly Stem: ").append((chineseYear - 1) % 10).append("\n");
        sb.append("Earthly Branch: ").append((chineseYear - 1) % 12).append("\n");
        sb.append("Chinese Month: ").append(chineseMonth).append("\n");
        sb.append("Chinese Date: ").append(chineseDate).append("\n");
        sb.append("Sectional Term: ").append(sectionalTerm).append("\n");
        sb.append("Principle Term: ").append(principleTerm).append("\n");
        return sb.toString();
    }
